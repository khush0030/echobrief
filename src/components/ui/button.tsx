  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-white text-primary hover:bg-white/90 shadow-lg hover:shadow-xl hover:-translate-y-1",
        heroOutline: "border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm hover:border-white/50",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow hover:shadow-glow-lg hover:-translate-y-0.5",
        recording: "bg-recording text-recording-foreground hover:bg-recording/90 shadow-recording",
        glass: "glass-button text-foreground hover:text-primary",
        glassAccent: "relative overflow-hidden bg-gradient-to-r from-accent to-accent/80 text-accent-foreground border border-accent/20 shadow-glow hover:shadow-glow-lg hover:-translate-y-0.5 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-500",
      },
      size: {
